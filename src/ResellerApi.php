...
use nextgi\LogicBoxes\Utils\Billing;
use nextgi\LogicBoxes\Utils\Contacts;
use nextgi\LogicBoxes\Utils\Customers;
use nextgi\LogicBoxes\Utils\Domains;
use nextgi\LogicBoxes\Utils\Orders;
use nextgi\LogicBoxes\Utils\Products;
use nextgi\LogicBoxes\Utils\Dns;
...
class ResellerApi
{
    ...
    private function _getAPI($api)
    {
        if (empty($this->apiList[$api])) {
            $class = 'nextgi\\LogicBoxes\\Utils\\'.$api;
